exports.sendNewPropertyMail = async (data) =>{
   return `<!DOCTYPE html
                                    ...
                                    <tr>
                                       <td class="es-m-p0r" valign="top" align="center"
                                          ...
                                          <table cellpadding="0" cellspacing="0" width="100%"
                                             style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                             <tr>
                                                <a href="https://mogroupltd.com" target="_blank"></a>
                                                <td align="center"
                                                   style="padding:0;Margin:0;padding-bottom:20px;font-size:0px"><img
                                                      src="https://ecuwtfj.stripocdn.email/content/guids/CABINET_1839e6502b500f84a14b19e20b46d1823b63ec4eae4a9612e8e7dac2e5635f8a/images/whatsapp_image_20231126_at_114054_f8360dfd_LVO.jpeg"
                                                      alt="Logo"
                                          ...
                                          <table cellpadding="0" cellspacing="0" width="100%"
                                             ...
                                             <tr>
                                                <td align="center"
                                                   ...
                                                   <img class="adapt-img" src="${data.image}" alt
                                             ...
                                             <tr>
                                                <td align="center"
                                                   ...
                                                   <p
                                                      ...
                                                      Get a new land of size ${data.size}Sqm at ${data.location} with as low as ${data.amount} now!
                                                   </p>
                                                </td>
                                             </tr>
                                          </table>
                                          ...
                                          <table cellpadding="0" cellspacing="0" width="100%"
                                             ...
                                             <tr>
                                                <td align="center" style="padding:0;Margin:0;padding-bottom:35px">
                                                   ...
                                                   <p
                                                      style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:18px;color:#333333;font-size:12px">
                                                      289 Old Abeokuta road Agege Lagos.</p>
                                                </td>
                                             </tr>
                                             <tr>
                                                <td style="padding:0;Margin:0">
                                                   <table cellpadding="0" cellspacing="0" width="100%" class="es-menu"
                                                      ...
                                                      <tr class="links">
                                                         <td align="center" valign="top" width="33.33%"
                                                            ...
                                                            <a target="_blank" href="https://mogroupltd.com"
                                                         ...
                                                         <td align="center" valign="top" width="33.33%"
                                                            ...
                                                            <a target="_blank"
                                                               href="https://infomogroupltd.com/privacy-policy"
                                                         ...
                                                         <td align="center" valign="top" width="33.33%"
                                                            style="Margin:0;padding-left:5px;padding-right:5px;padding-top:5px;padding-bottom:5px;border:0;border-left:1px solid #cccccc">
                                                            <a target="_blank"
                                                               href="https://www.infomogroupltd.com/terms-condition"
...
exports.sendNewTransportMail = async (data) =>{
   return `<!DOCTYPE html
   PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en">
                                          ...
                                          <table cellpadding="0" cellspacing="0" width="100%"
                                             ...
                                             <tr>
                                                <td align="center"
                                                   ...
                                                   <p
                                                      style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                      Invest in ${data.name} with as low as ${data.amount} in a new set of Tranportation vehicle now!</p>
                                                   </p>
                                                </td>
                                             </tr>
                                          </table>
